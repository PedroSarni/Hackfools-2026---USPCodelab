...
var wasmImports = {
                 ...
                 nb: JsOnSimpleListenerBinaryArray,
                 ...
                 Jc: JsWrapErrorListenerInternal,
                 mb: JsWrapImageConverter,
                 Ic: JsWrapLoggingHelpers,
                 v: JsWrapSimpleListeners,
                 lb: UseBottomLeftGpuOrigin,
                 wb: __asyncjs__mediapipe_map_buffer_jspi,
                 u: ___cxa_throw,
                 Hc: ___syscall_dup,
                 Gc: ___syscall_faccessat,
                 kb: ___syscall_fcntl64,
                 ...
                 wc: __abort_js,
                 Hb: __embind_register_bigint,
                 vc: __embind_register_bool,
                 uc: __embind_register_emval,
                 hb: __embind_register_float,
                 J: __embind_register_integer,
                 q: __embind_register_memory_view,
                 tc: __embind_register_std_string,
                 La: __embind_register_std_wstring,
                 sc: __embind_register_void,
                 aa: __emval_create_invoker,
                 p: __emval_decref,
                 Ka: __emval_get_global,
                 gb: __emval_get_property,
                 ja: __emval_incref,
                 Ja: __emval_instanceof,
                 $: __emval_invoke,
                 ua: __emval_new_cstring,
                 _: __emval_run_destructors,
                 ...
                 qc: __tzset_js,
                 Jb: _clock_time_get,
                 pc: custom_emscripten_dbgn,
                 Z: _emscripten_asm_const_int,
                 eb: _emscripten_asm_const_ptr,
                 Ia: _emscripten_errn,
                 oc: _emscripten_get_heap_max,
                 y: _emscripten_get_now,
                 S: _emscripten_has_asyncify,
                 nc: _emscripten_outn,
                 mc: _emscripten_pc_get_function,
                 lc: _emscripten_resize_heap,
                 db: _emscripten_stack_snapshot,
                 kc: _emscripten_stack_unwind_buffer,
                 jc: _emscripten_webgl_create_context,
                 ic: _emscripten_webgl_destroy_context,
                 hc: _emscripten_webgl_get_context_attributes,
                 ia: _emscripten_webgl_get_current_context,
                 gc: _emscripten_webgl_make_context_current,
                 P: _emscripten_webgpu_get_device,
                 fc: _emwgpuBufferDestroy,
                 ec: _emwgpuBufferGetMappedRange,
                 dc: _emwgpuBufferUnmap,
                 t: _emwgpuDelete,
                 cc: _emwgpuDeviceCreateBuffer,
                 Bb: _emwgpuDeviceCreateComputePipelineAsync,
                 Ab: _emwgpuDeviceCreateRenderPipelineAsync,
                 bc: _emwgpuDeviceCreateShaderModule,
                 ac: _emwgpuDeviceDestroy,
                 $b: _emwgpuWaitAny,
                 Ac: _environ_get,
                 ...
                 b: _glActiveTexture,
                 ta: _glAttachShader,
                 _b: _glBindAttribLocation,
                 c: _glBindBuffer,
                 bb: _glBindBufferBase,
                 ...
                 Mb: _glUniformMatrix2fv,
                 Lb: _glUniformMatrix3fv,
                 Ga: _glUniformMatrix4fv,
                 g: _glUseProgram,
                 k: _glVertexAttribPointer,
                 U: _glViewport,
                 zb: mediapipe_create_utility_canvas2d,
                 yb: _mediapipe_find_canvas_event_target,
                 xb: mediapipe_import_external_texture,
                 vb: _mediapipe_webgl_tex_image_drawable,
                 yc: _proc_exit,
                 xc: _random_get,
                 Fa: _wgpuCommandEncoderBeginComputePass,
                 Ea: _wgpuCommandEncoderBeginRenderPass,
                 ub: _wgpuCommandEncoderCopyBufferToTexture,
                 tb: _wgpuCommandEncoderCopyTextureToBuffer,
                 sb: _wgpuCommandEncoderCopyTextureToTexture,
                 ...
                 da: _wgpuDeviceCreateBindGroup,
                 rb: _wgpuDeviceCreateBindGroupLayout,
                 L: _wgpuDeviceCreateCommandEncoder,
                 qb: _wgpuDeviceCreateComputePipeline,
                 pb: _wgpuDeviceCreatePipelineLayout,
                 Qa: _wgpuDeviceCreateRenderPipeline,
                 T: _wgpuDeviceCreateSampler,
                 ca: _wgpuDeviceCreateTexture,
                 K: _wgpuQueueSubmit,
                 ka: _wgpuQueueWriteBuffer,
                 ob: _wgpuQueueWriteTexture,
                 ...
                 Pa: _wgpuRenderPipelineGetBindGroupLayout,
                 z: _wgpuTextureCreateView,
                 Oa: _wgpuTextureDestroy,
                 ba: _wgpuTextureGetFormat
};
